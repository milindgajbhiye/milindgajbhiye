...
- 🧠 Choosing Java for DSA to develop strong logic and structured problem-solving  
- 🤖 Exploring AI applications like emotion detection and automation tools  
- 📊 Designing backend systems such as Mediser and Student Management with clean architecture  
- 📡 Working with real-world data through scraping and structured extraction  
- 🎨 Balancing technical logic with creativity through 3D modeling projects  
- 🔁 Staying consistent even when debugging takes longer than expected  
...
- 🚀 Hackathons and rapid prototyping builds  
- 🧠 Problem-solving focused development teams  
